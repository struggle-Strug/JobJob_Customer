...
const CustomerSignIn = () => {
  ...
  const metadata = {
    title: "採用担当者様向けのログイン画面 | JobJob (ジョブジョブ)",
    description: "採用担当者様専用のログインページです。ログインID、パスワードを半角英数字でご入力後、「ログイン」ボタンを押してください。",
    keywords: "医療,介護,求人,転職,募集,パート,アルバイト,バイト,看護師,医師,薬剤師",
    canonical: `${import.meta.env.VITE_APP_BASE_URL}/customers/sign_in`,
  };
  return (
    <>
      <Helmet>
      ...
      <div className="pt-16 pb-8 bg-[#F8F8F8] min-h-screen">
